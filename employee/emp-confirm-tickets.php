<?php
    ...
    if(isset($_POST['train_fare_confirm_checkout'])){
      if (isset($_SESSION['train_fare_confirm_checkout_clicked_time']) && (time() - $_SESSION['train_fare_confirm_checkout_clicked_time']) <= 5) {
        $err = "Ticket Payment alredy Confirmed";
    } else {
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="pass_train_route"  value="<?php echo $row->pass_train_route;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Departure Date</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  name = "train_dep_date" value="<?php echo $row->train_dep_date;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Departure Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  name = "train_dep_time" value="<?php echo $row->train_dep_time;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Arrival Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name = "train_arr_time" value="<?php echo $row->train_arr_time;?>" id="inputText3" type="text">
                      </div>
                    </div>                   
                    <div class="form-group row">
