                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->departure_time;?></td>
                        <td class="center"><?php echo $row->arrival_time;?></td>
                        <td class="center">₹<?php echo $row->fare;?></td>
                        <td class="center"><?php echo $row->passengers;?></td>
                        <td class="center">
                            <a class ="badge badge-success" href ="emp-update-train.php?id=<?php echo $row->id;?>">Update</a> 
                            <a class ="badge badge-danger" href ="emp-manage-train.php?del=<?php echo $row->id;?>">Delete</a>
                            <a class ="badge badge-primary" href ="emp-view-train.php?id=<?php echo $row->id;?>">View</a>
                        </td>                      
                      </tr>
                        <?php }?>
                    </tbody>
