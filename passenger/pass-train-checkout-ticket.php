                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                         ...
                         */
                            //$aid=$_SESSION['pass_id'];
                            $ret="SELECT * FROM orrs_passenger WHERE pass_id=? && pass_fare_payment_code = '' && pass_train_number!=''";//sql to get details of our user
                            $stmt= $mysqli->prepare($ret) ;
                            $stmt->bind_param('i',$aid);
                            $stmt->execute() ;//ok
                            $res=$stmt->get_result();
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->pass_train_route;?></td>
                        <td class="center"><?php echo $row->pass_dep_date;?></td>
                        <td class="center"><?php echo $row->pass_dep_station_time;?></td>
                        <td class="center"><?php echo $row->pass_arr_station_time;?></td>
