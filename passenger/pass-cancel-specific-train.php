<?php
    ...
    if(isset($_POST['Cancel_Train'])){
      if (isset($_SESSION['Cancel_Train_clicked_time']) && (time() - $_SESSION['Cancel_Train_clicked_time']) <= 10) {
        $err = "Reserved Train already Cancelled";
    } else {
        $_SESSION['Cancel_Train_clicked_time'] = time();
              ...
              <div class="card card-border-color card-border-color-primary">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-outline-primary" value ="Cancel Train" name = "Cancel_Train" type="submit" onclick="disableButton()">
