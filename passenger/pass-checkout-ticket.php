<?php
  ...
  //   if (isset($_SESSION['train_fare_checkout_clicked']) && $_SESSION['train_fare_checkout_clicked'] === true) {
  ...
  //         $_SESSION['train_fare_checkout_clicked'] = false;
  //         unset($_SESSION['train_fare_checkout_clicked_time']); // unset the time variable
  //     } else {
  ...
  //   {
  //           $_SESSION['train_fare_checkout_clicked'] = true;
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="pass_dep_time" value="<?php echo $row->pass_dep_time;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
