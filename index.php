					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">(+91) 6360364431</li>
								<li class="icon solid fa-envelope"><a href="#">darshanmoger54@gmail.com</a></li>
								<li class="icon brands fa-github"><a href="#">github.com/drsnpm/</a></li>
								<li class="icon brands fa-facebook-f"><a href="#">Darshan Moger</a></li>
								<li class="icon brands fa-instagram"><a href="#">drsn_pm</a></li>
							</ul>
							<ul class="copyright">
