<?php
  ...
  //   if (isset($_SESSION['Update_Profile_clicked']) && $_SESSION['Update_Profile_clicked'] === true) {
  ...
  //         $_SESSION['Update_Profile_clicked'] = false;
  //         unset($_SESSION['Update_Profile_clicked_time']); // unset the time variable
  //     } else {
  ...
  //   {
  //           $_SESSION['Update_Profile_clicked'] = true;
